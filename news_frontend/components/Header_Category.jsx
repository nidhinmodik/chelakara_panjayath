        ...
        <div className='w-full'>
            <div className='bg-[#c80000] w-full text-white uppercase font-semibold relative'>
                <div className='px-2 flex justify-between items-center relative h-[50px]'>
                    ...
                    <Link className={`px-2 bg-[#c80000] text-xs my-2 ${path === '/' ? 'bg-[#00000026]' : ''}`} href="https://api.whatsapp.com/send?phone=+918943947138" target='_blank' >ഷെയർ ന്യൂസ്/റിവ്യൂ</Link>
                    <div className='flex-wrap hidden lg:flex'>
                        ...
                        <Link className={`px-2 bg-[#c80000] mx-4 text-xs py-[8px] ${path === '/' ? 'bg-[#00000026]' : ''}`} href={'/news/category/Ward'} >വാർഡുതല വാർത്തകൾ</Link>
                        <Link className={`px-2 bg-[#c80000] mx-4 text-xs py-[8px] ${path === '/' ? 'bg-[#00000026]' : ''}`} href={'/news/category/Kerala'} >കേരള വാർത്തകൾ</Link>
                        <Link className={`px-2 bg-[#c80000] mx-4 text-xs py-[8px] ${path === '/' ? 'bg-[#00000026]' : ''}`} href={'/news/category/Daily'} >Daily Challenges</Link>
